...
### JsVal(int)
`public JsVal(int value);`

指定された int 値で、JSのNumberを表現するJsValインスタンスを生成して返す。

### JsVal(float)
`public JsVal(float value);`

指定された float 値で、JSのNumberを表現するJsValインスタンスを生成して返す。

### JsVal(bool)
`public JsVal(bool value);`

指定された bool 値で、JSのBooleanを表現するJsValインスタンスを生成して返す。

### JsVal(string)
`public JsVal(string value);`

指定された string 値で、JSのStringを表現するJsValインスタンスを生成して返す。

### JsVal(list&lt;int>)
`public JsVal(list<int> value);`

指定されたint型のlistから、JSのArrayを表現するJsValインスタンスを生成して返す。

### JsVal(list&lt;float>)
`public JsVal(list<float> value);`

指定されたfloat型のlistから、JSのArrayを表現するJsValインスタンスを生成して返す。

### JsVal(list&lt;bool>)
`JsVal(list<bool> value);`

指定されたbool型のlistから、JSのArrayを表現するJsValインスタンスを生成して返す。

### JsVa(list&lt;string>)
`JsVal(list<string> value);`

指定されたstring型のlistから、JSのArrayを表現するJsValインスタンスを生成して返す。
...
プロパティの名前を name で指定してJsPropを生成する。

### JsProp(string, JsVal)
`JsProp(string name, JsVal value);`

プロパティの名前を name、値を value で指定してJsPropを生成する。
